package com.gy.androidpicker.filepicker.widget;
...
/**
 * 重写ListView，以达到水平滑动，诸如可用于文件浏览器的路径。
 * 参见：https://github.com/kk-java/HorizontalListView
 *
...
public class HorizontalListView extends AdapterView<ListAdapter> {
     ...
     */
    private static class YScrollView extends ScrollView {
